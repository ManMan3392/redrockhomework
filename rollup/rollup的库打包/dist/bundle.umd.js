  ...
  **/
  ...
  return (_ctx, _cache) => {
    return (openBlock(), createElementBlock("div", _hoisted_1, [
      createBaseVNode("h2", null, toDisplayString(count.value), 1 /* TEXT */),
      createBaseVNode("button", { onClick: increment }, "+"),
      createBaseVNode("button", { onClick: decrement }, "-"),
      _cache[0] || (_cache[0] = createBaseVNode("p", null, "这是一个 Vue 组件", -1 /* CACHED */))
    ]))
  }
  }
